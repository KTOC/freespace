...
{    
    ...
    dwDataConditioner_prepareData(m_deviceInputData, &frame, 1, &roi,
                                  cudaAddressModeClamp, m_dataConditionerHandle);
